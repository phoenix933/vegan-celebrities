...
export function reducer(state = initialState, action: fromActions.AuthAction): AuthState {
    switch (action.type) {
        ...
        case AuthActionTypes.SignInWithEmailAndPassword: {
            return {
                ...state,
                signInLoading: true
            };
        ...
        case AuthActionTypes.SignInWithEmailAndPasswordSuccess: {
            return {
                ...state,
        ...
        case AuthActionTypes.SignInWithEmailAndPasswordFailure: {
            return {
                ...state,
                signInLoading: false
            };
